    ...
    <body data-mobile-nav-style="classic">
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-12 col-xl-6 col-lg-8 text-center position-relative page-title-double-large">
                        <div class="d-flex flex-column justify-content-center extra-very-small-screen">
                            <h1 class="text-dark-gray alt-font ls-minus-1px fw-700 mb-20px">Alert boxes</h1>
                            <h2 class="text-dark-gray d-inline-block fw-400 ls-0px mb-0">Leverage alert boxes for effective messaging. Whether a warning or affiliate disclosure, its convey messages swiftly.</h2> 
                        </div>
            ...
            <div class="container">
                <div class="row justify-content-center mb-3">
                    <div class="col-12 col-lg-7 text-center">
                        <h6 class="alt-font text-dark-gray fw-700">Alert box style 01</h6>
                    </div>
                </div>
        ...
        <section class="bg-very-light-gray">
            <div class="container">
                <div class="row justify-content-center mb-3">
                    <div class="col-12 col-lg-7 text-center">
                        <h6 class="alt-font text-dark-gray fw-600">Alert box style 02</h6>
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-8 alert-box-style-02">
                        <!-- start alert box item -->
                        <div class="alert alert-success alert-dismissable bg-white">
                            <a href="#" class="close" data-bs-dismiss="alert" aria-label="close"><i class="feather icon-feather-x-circle"></i></a>
                            <strong>Success!</strong> Indicates a successful or positive action.
                        </div>
                        <!-- end alert box item -->
                        <!-- start alert box item -->
                        <div class="alert alert-info alert-dismissable bg-white">
                            <a href="#" class="close" data-bs-dismiss="alert" aria-label="close"><i class="feather icon-feather-x-circle"></i></a>
                            <strong>Info!</strong> Indicates a neutral informative change or action.
                        </div>
                        <!-- end alert box item -->
                        <!-- start alert box item -->
                        <div class="alert alert-warning alert-dismissable bg-white">
                            <a href="#" class="close" data-bs-dismiss="alert" aria-label="close"><i class="feather icon-feather-x-circle"></i></a>
                            <strong>Warning!</strong> Indicates a warning that might need attention.
                        </div>
                        <!-- end alert box item -->
                        <!-- start alert box item -->
                        <div class="alert alert-danger alert-dismissable bg-white">
                            <a href="#" class="close" data-bs-dismiss="alert" aria-label="close"><i class="feather icon-feather-x-circle"></i></a>
                            <strong>Danger!</strong> Indicates a dangerous or potentially negative action.
                        </div>
                        <!-- end alert box item -->
        ...
        <section>
            <div class="container">
                <div class="row justify-content-center mb-3">
                    <div class="col-12 col-lg-7 text-center">
                        <h6 class="alt-font text-dark-gray fw-600">Alert box style 03</h6>
                    </div>
                </div>
                <div class="row row justify-content-center">
                    <div class="col-12 col-lg-8 alert-box-style-03">
                        <!-- start alert box item -->
                        <div class="alert alert-success alert-dismissable text-white">
                            <a href="#" class="close float-end" data-bs-dismiss="alert" aria-label="close"><i class="feather icon-feather-x text-white"></i></a>
                        ...
                        <!-- end alert box item -->
                        <!-- start alert box item -->
                        <div class="alert alert-warning alert-dismissable text-white">
                            <a href="#" class="close float-end" data-bs-dismiss="alert" aria-label="close"><i class="feather icon-feather-x text-white"></i></a>
                            Warning! Indicates a successful or positive action.
                        </div>
                        <!-- end alert box item -->
                        <!-- start alert box item -->
                        <div class="alert alert-danger alert-dismissable text-white">
                            <a href="#" class="close float-end" data-bs-dismiss="alert" aria-label="close"><i class="feather icon-feather-x text-white"></i></a>
                            Danger! Indicates a successful or positive action.
                        </div>
                        <!-- end alert box item -->
                    </div>
                </div>
        ...
        <section class="bg-very-light-gray">
            <div class="container">
                <div class="row justify-content-center mb-3">
                    <div class="col-12 col-lg-7 text-center">
                        <h6 class="alt-font text-dark-gray fw-600">Alert box style 04</h6>
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-8 alert-box-style-04">
                        <!-- start alert box item -->
                        ...
                        <!-- end alert box item -->
                        <!-- start alert box item -->
                        <div class="alert alert-warning box-shadow-extra-large bg-white alert-dismissable">
                            <a href="#" class="close" data-bs-dismiss="alert" aria-label="close"><i class="fa-solid fa-xmark"></i></a>
                            <strong>Warning!</strong> Indicates a warning that might need attention.
                        </div>
                        <!-- end alert box item -->
        ...
        <section>
            <div class="container">
                <div class="row justify-content-center mb-3">
                    <div class="col-12 col-lg-7 text-center">
                        <h6 class="alt-font text-dark-gray fw-600">Alert box style 05</h6>
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-8 alert-box-style-05">
                        <!-- start alert box item -->
                        <div class="alert alert-success alert-dismissable">
