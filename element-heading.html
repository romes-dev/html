    ...
    <body data-mobile-nav-style="classic">
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-12 col-xl-6 col-lg-8 text-center position-relative page-title-double-large">
                        <div class="d-flex flex-column justify-content-center extra-very-small-screen">
                            <h1 class="text-dark-gray alt-font ls-minus-1px fw-700 mb-20px">Heading</h1>
                            <h2 class="text-dark-gray d-inline-block fw-400 ls-0px mb-0">Craft an appealing header using the heading with subtitles, descriptions, style controls, and parallax background.</h2> 
                        </div>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 col-xl-8 last-paragraph-no-margin">
                        <h1 class="text-dark-gray alt-font fw-600">Heading <span class="text-light-gray">(H1)</span></h1>
        ...
        <section class="pb-0">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 col-xl-8 last-paragraph-no-margin">
                        <h2 class="text-dark-gray alt-font fw-600">Heading <span class="text-light-gray">(H2)</span></h2>
                        <p>Ferri reque integre mea ut, eu eos vide errem noluisse. Putent laoreet et ius. Vel utroque dissentias ut, nam ad soleat alterum maluisset, cu est copiosae intellegat inciderint. Nam ei eirmod consequuntur, quod nostrum consectetuer usu ut.</p>
                    </div>
                </div>
            </div>
        ...
        <section class="pb-0">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 col-xl-8 last-paragraph-no-margin">
                        <h3 class="text-dark-gray alt-font fw-600">Heading <span class="text-light-gray">(H3)</span></h3>
                        <p>Ferri reque integre mea ut, eu eos vide errem noluisse. Putent laoreet et ius. Vel utroque dissentias ut, nam ad soleat alterum maluisset, cu est copiosae intellegat inciderint. Nam ei eirmod consequuntur, quod nostrum consectetuer usu ut.</p>
                    </div>
                </div>
            </div>
        ...
        <section class="pb-0">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 col-xl-8 last-paragraph-no-margin">
                        <h4 class="text-dark-gray alt-font fw-600">Heading <span class="text-light-gray">(H4)</span></h4>
                        <p>Ferri reque integre mea ut, eu eos vide errem noluisse. Putent laoreet et ius. Vel utroque dissentias ut, nam ad soleat alterum maluisset, cu est copiosae intellegat inciderint. Nam ei eirmod consequuntur, quod nostrum consectetuer usu ut.</p>
                    </div>
                </div>
            </div>
        ...
        <section class="pb-0">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 col-xl-8 last-paragraph-no-margin">
                        <h5 class="text-dark-gray alt-font fw-600">Heading <span class="text-light-gray">(H5)</span></h5>
                        <p>Ferri reque integre mea ut, eu eos vide errem noluisse. Putent laoreet et ius. Vel utroque dissentias ut, nam ad soleat alterum maluisset, cu est copiosae intellegat inciderint. Nam ei eirmod consequuntur, quod nostrum consectetuer usu ut.</p>
                    </div>
                </div>
            </div>
        ...
        <section>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 col-xl-8 last-paragraph-no-margin">
                        <h6 class="text-dark-gray alt-font fw-600">Heading <span class="text-light-gray">(H6)</span></h6>
                        <p>Ferri reque integre mea ut, eu eos vide errem noluisse. Putent laoreet et ius. Vel utroque dissentias ut, nam ad soleat alterum maluisset, cu est copiosae intellegat inciderint. Nam ei eirmod consequuntur, quod nostrum consectetuer usu ut.</p>
                    </div>
                </div>
            </div>
