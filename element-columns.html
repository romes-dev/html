    ...
    <body data-mobile-nav-style="classic">
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-12 col-xl-6 col-lg-8 text-center position-relative page-title-double-large">
                        <div class="d-flex flex-column justify-content-center extra-very-small-screen">
                            <h1 class="text-dark-gray alt-font ls-minus-1px fw-700 mb-20px">Columns</h1>
                            <h2 class="text-dark-gray d-inline-block fw-400 ls-0px mb-0">Divides content into columns, simplifying organization for improved structure, arrangement, and enhanced readability.</h2> 
                        </div>
            ...
            <div class="container">
                <div class="row justify-content-center mb-3">
                    <div class="col-md-12 text-center">
                        <h6 class="alt-font text-dark-gray fw-600">Full width</h6>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
        ...
        <section>
            <div class="container">
                <div class="row justify-content-center mb-3">
                    <div class="col-md-12 text-center">
                        <h6 class="alt-font text-dark-gray fw-600">One third</h6>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12 col-lg-4 md-mb-15px">
                        <div class="bg-very-light-gray p-40px sm-p-30px last-paragraph-no-margin">
                            <h5 class="text-dark-gray">1/3</h5>
        ...
        <section class="bg-very-light-gray">
            <div class="container">
                <div class="row justify-content-center mb-3">
                    <div class="col-md-12 text-center">
                        <h6 class="alt-font text-dark-gray fw-600">One fourth</h6>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12 col-lg-3 md-mb-15px">
                        <div class="bg-white p-40px sm-p-30px last-paragraph-no-margin box-shadow-small">
                            <h5 class="text-dark-gray">1/4</h5>
        ...
        <section>
            <div class="container">
                <div class="row justify-content-center mb-3">
                    <div class="col-md-12 text-center">
                        <h6 class="alt-font text-dark-gray fw-600">One third / Two third</h6>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12 col-lg-4 md-mb-15px">
                    ...
                    <div class="col-12 col-lg-8 md-mb-15px">
                        <div class="bg-very-light-gray p-40px sm-p-30px last-paragraph-no-margin">
                            <h5 class="text-dark-gray">2/3</h5>
        ...
        <section class="bg-very-light-gray">
            <div class="container">
                <div class="row justify-content-center mb-3">
                    <div class="col-md-12 text-center">
                        <h6 class="alt-font text-dark-gray fw-600">Third fourth / One fourth</h6>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12 col-lg-9 md-mb-15px">
                        <div class="bg-white p-40px sm-p-30px last-paragraph-no-margin box-shadow-small">
                            <h5 class="text-dark-gray">3/4</h5>
                    ...
                    <div class="col-12 col-lg-3 md-mb-15px">
                        <div class="bg-white p-40px sm-p-30px last-paragraph-no-margin box-shadow-small">
                            <h5 class="text-dark-gray">1/4</h5>
                            <p>Lorem ipsum is simply dummy text of the printing industry. Lorem ipsum has been a galley of specimen book.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section>
            <div class="container">
                <div class="row justify-content-center mb-3">
                    <div class="col-md-12 text-center">
                        <h6 class="alt-font text-dark-gray fw-600">Grid structure</h6>
                    </div>
                </div>
            </div>
            <div class="container">
