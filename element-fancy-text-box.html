                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-12 col-xl-6 col-lg-8 text-center position-relative page-title-double-large">
                        <div class="d-flex flex-column justify-content-center extra-very-small-screen">
                            <h1 class="text-dark-gray alt-font ls-minus-1px fw-700 mb-20px">Fancy text box</h1>
                            <h2 class="text-dark-gray d-inline-block fw-400 ls-0px mb-0">Fancy text boxes upgrade your text's look, adding stylish borders, colors, and fonts for a visually striking effect</h2> 
                        </div>
                        ...
                        <div class="text-box-wrapper align-items-center d-flex">
                            <div class="position-relative text-center w-100">
                                ...
                                <div class="text-box-hover p-16 lg-p-12 md-p-17 sm-p-12 xs-p-17"> 
                                    <p class="mb-15px">Lorem ipsum dolor consectetur adipiscing do eiusmod tempor ipsum dolor.</p>
                        ...
                        <div class="text-box-wrapper align-items-center d-flex">
                            <div class="position-relative text-center w-100">
                                <div class="text-box last-paragraph-no-margin p-14">
                                    ...
                                    <span class="text-dark-gray fw-600 fs-22 lg-fs-20">Innovation</span>
                                    <p>Lorem ipsum dolor</p>
                                </div>
                                <div class="text-box-hover p-16 lg-p-12 md-p-17 sm-p-12 xs-p-17">
                                    <p class="mb-15px">Lorem ipsum dolor consectetur adipiscing do eiusmod tempor ipsum dolor.</p>
                                    <a href="#" class="btn btn-link btn-large text-base-color thin fw-700">Innovation ideas</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="text-box-wrapper align-items-center d-flex">
                            <div class="position-relative text-center w-100">
                                <div class="text-box last-paragraph-no-margin p-14">
                                    ...
                                    <span class="text-dark-gray fw-600 fs-22 lg-fs-20">Analytics</span>
                                    <p>Lorem ipsum dolor</p>
                                </div>
                                <div class="text-box-hover p-16 lg-p-12 md-p-17 sm-p-12 xs-p-17"> 
                                    <p class="mb-15px">Lorem ipsum dolor consectetur adipiscing do eiusmod tempor ipsum dolor.</p>
                                    <a href="#" class="btn btn-link btn-large text-base-color thin fw-700">Good analytics</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="text-box-wrapper align-items-center d-flex">
                            <div class="position-relative text-center w-100">
                                <div class="text-box last-paragraph-no-margin p-14">
                                    ...
                                    <span class="text-dark-gray fw-600 fs-22 lg-fs-20">Planning</span>
                                    <p>Lorem ipsum dolor</p>
                                </div>
                                <div class="text-box-hover p-16 lg-p-12 md-p-17 sm-p-12 xs-p-17"> 
                                    <p class="mb-15px">Lorem ipsum dolor consectetur adipiscing do eiusmod tempor ipsum dolor.</p>
                                    <a href="#" class="btn btn-link btn-large text-base-color thin fw-700">Strategic planning</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="bg-solitude-blue">
            <div class="container">
                <div class="row justify-content-center mb-3">
                    <div class="col-xl-6 col-md-8 text-center" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        <span class="bg-majorelle-blue text-uppercase fs-13 ps-25px pe-25px alt-font fw-600 text-white lh-40 sm-lh-55 border-radius-100px d-inline-block mb-25px">Process cycle</span>
                        <h2 class="text-dark-gray fw-600 ls-minus-2px">Smart and effective business solutions</h2>
                    </div>
                </div>
