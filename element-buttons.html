    ...
    <body data-mobile-nav-style="classic">
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-12 col-xl-6 col-lg-8 text-center position-relative page-title-double-large">
                        <div class="d-flex flex-column justify-content-center extra-very-small-screen">
                            <h1 class="text-dark-gray alt-font ls-minus-1px fw-700 mb-20px">Buttons</h1>
                            <h2 class="text-dark-gray d-inline-block fw-400 ls-0px mb-0">Add buttons anywhere, customize with styles and include actions easily for links and CTA elements on your page.</h2> 
                        </div>
            ...
            <div class="container">
                <div class="row justify-content-center mb-2">
                    <div class="col-12 col-lg-7 text-center">
                        <h6 class="alt-font text-dark-gray fw-600">Button sizes</h6>
                    </div>
                </div>
                <div class="row row-cols-1 justify-content-center">
                    <div class="col btn-dual text-center">
                        <a href="#" class="btn btn-base-color btn-extra-large d-table d-lg-inline-block lg-mb-15px md-mx-auto">Button Extra Large</a>
                        <a href="#" class="btn btn-base-color btn-large d-table d-lg-inline-block lg-mb-15px md-mx-auto">Button Large</a>
                        <a href="#" class="btn btn-base-color btn-medium d-table d-lg-inline-block lg-mb-15px md-mx-auto">Button Medium</a>
                        <a href="#" class="btn btn-base-color btn-small d-table d-lg-inline-block lg-mb-15px md-mx-auto">Button Small</a>
                        <a href="#" class="btn btn-base-color btn-very-small d-table d-lg-inline-block lg-mb-15px md-mx-auto">Very Small</a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="big-section">
            <div class="container">
                <div class="row justify-content-center mb-2">
                    <div class="col-12 col-lg-7 text-center">
                        <h6 class="alt-font text-dark-gray fw-600">Button shapes</h6>
                    </div>
                </div>
                <div class="row row-cols-1 justify-content-center">
                    <div class="col btn-dual text-center">
                        <a href="#" class="btn btn-dark-gray btn-large d-table d-lg-inline-block lg-mb-15px md-mx-auto">Button Default</a>
                        <a href="#" class="btn btn-dark-gray btn-large btn-round-edge d-table d-lg-inline-block lg-mb-15px md-mx-auto">Button Round Edges</a>
                        <a href="#" class="btn btn-dark-gray btn-large btn-rounded d-table d-lg-inline-block lg-mb-15px md-mx-auto">Button Rounded</a>
                    </div>
                </div>
            </div>
        </section>
        <!-- end section -->
        <!-- start section -->
        <section class="bg-gradient-light-pink-light-orange big-section">
            <div class="container">
                <div class="row justify-content-center mb-2">
                    <div class="col-12 col-lg-7 text-center">
                        <h6 class="alt-font text-dark-gray fw-600">Fill background</h6>
                    </div>
                </div>
                <div class="row row-cols-1 justify-content-center">
                    <div class="col btn-dual text-center">
                        <a href="#" class="btn btn-large btn-base-color d-table d-lg-inline-block lg-mb-15px md-mx-auto">Button base color</a>
                        <a href="#" class="btn btn-large btn-black d-table d-lg-inline-block lg-mb-15px md-mx-auto">Button black</a>
                        <a href="#" class="btn btn-large btn-white d-table d-lg-inline-block lg-mb-15px md-mx-auto">Button white</a>
                        <a href="#" class="btn btn-large btn-dark-gray d-table d-lg-inline-block lg-mb-15px md-mx-auto">Button dark gray</a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="big-section">
            <div class="container">
                <div class="row justify-content-center mb-2">
                    <div class="col-12 col-lg-7 text-center">
                        <h6 class="alt-font text-dark-gray fw-600">Only border</h6>
                    </div>
                </div>
                <div class="row row-cols-1 justify-content-center">
                    <div class="col btn-dual text-center">
                        <a href="#" class="btn btn-extra-large btn-transparent-base-color d-table d-lg-inline-block lg-mb-15px md-mx-auto">Border base color</a>
                        <a href="#" class="btn btn-extra-large btn-round-edge btn-transparent-light-gray d-table d-lg-inline-block lg-mb-15px md-mx-auto">Border light color</a>
                        <a href="#" class="btn btn-extra-large btn-rounded btn-transparent-dark-gray d-table d-lg-inline-block lg-mb-15px md-mx-auto">Border dark gray</a>
                    </div>
                </div>
            </div>
        </section>
        <!-- end section -->
        <!-- start section -->
        <section class="bg-charcoal-blue big-section">
            <div class="container">
                <div class="row justify-content-center mb-2">
                    <div class="col-12 col-lg-7 text-center">
                        <h6 class="alt-font text-white fw-600">Gradient button</h6>
                    </div>
                </div>
                <div class="row row-cols-1 justify-content-center">
                    <div class="col btn-dual text-center">
                        <a href="#" class="btn btn-large btn-gradient-sky-blue-pink d-table d-lg-inline-block xl-mb-15px md-mx-auto">Gradient Button</a>
                        <a href="#" class="btn btn-large btn-gradient-purple-pink d-table d-lg-inline-block xl-mb-15px md-mx-auto">Gradient Button</a>
                        <a href="#" class="btn btn-large btn-gradient-fast-pink-light-yellow d-table d-lg-inline-block xl-mb-15px md-mx-auto">Gradient Button</a>
                        <a href="#" class="btn btn-large btn-gradient-pink-orange d-table d-lg-inline-block xl-mb-15px md-mx-auto">Gradient Button</a>
                        <a href="#" class="btn btn-large btn-gradient-fast-blue-purple d-table d-lg-inline-block xl-mb-15px md-mx-auto">Gradient Button</a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="bg-very-light-gray big-section">
            <div class="container">
                <div class="row justify-content-center mb-2">
                    <div class="col-12 col-lg-7 text-center">
                        <h6 class="alt-font text-dark-gray fw-600">With icon</h6>
                    </div>
                </div>
                <div class="row row-cols-1 justify-content-center">
                    <div class="col btn-dual text-center">
                        <a href="#" class="btn btn-large btn-white btn-box-shadow fw-600 d-table d-lg-inline-block lg-mb-15px md-mx-auto">Shadow button<i class="fa-solid fa-arrow-right"></i></a>
                        <a href="#" class="btn btn-large btn-base-color left-icon d-table d-lg-inline-block lg-mb-15px md-mx-auto"><i class="fa-solid fa-arrow-left"></i>Back to blog</a>
                        <a href="#" class="btn btn-large btn-transparent-dark-gray d-table d-lg-inline-block lg-mb-15px md-mx-auto">Checkout now<i class="feather icon-feather-shopping-bag"></i></a>
                        <a href="#" class="btn btn-large btn-gradient-purple-pink d-table d-lg-inline-block lg-mb-15px md-mx-auto">Instagram<i class="fa-brands fa-instagram"></i></a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="big-section">
            <div class="container-fluid">
                <div class="row justify-content-center mb-1">
                    <div class="col-12 col-lg-7 text-center">
                        <h6 class="alt-font text-dark-gray fw-600">Text link</h6>
                    </div>
                </div>
                <div class="row row-cols-1 justify-content-center">
                    <div class="col btn-dual text-center">
                        <a href="#" class="btn btn-link-gradient btn-medium text-gradient-fast-blue-purple d-table d-lg-inline-block xl-mb-15px md-mx-auto">Only Gradient<span class="bg-gradient-fast-blue-purple"></span></a>
                        <a href="#" class="btn btn-link btn-medium text-base-color d-table d-lg-inline-block xl-mb-15px md-mx-auto">With underline</a>
                        <a href="#" class="btn btn-link-gradient btn-medium text-gradient-light-pink-light-purple thin d-table d-lg-inline-block xl-mb-15px md-mx-auto">Thin underline<span class="bg-gradient-light-pink-light-purple"></span></a>
                        <a href="#" class="btn btn-link underline-on-hover btn-medium text-dark-gray d-table d-lg-inline-block xl-mb-15px md-mx-auto">Underline on hover</a>
                        <a href="#" class="btn btn-link hover-text-dark btn-extra-large text-dark-gray d-table d-lg-inline-block xl-mb-15px md-mx-auto">Dark on hover</a>
                        <a href="#" class="btn btn-link hover-text-light btn-extra-large text-dark-gray d-table d-lg-inline-block xl-mb-15px md-mx-auto">Light on hover</a>
                        <a href="#" class="btn btn-link-gradient expand btn-extra-large text-dark-gray d-table d-lg-inline-block xl-mb-15px md-mx-auto">Download schedule<span class="bg-dark-gray"></span></a>
                        <a href="#" class="btn btn-link btn-hover-animation-switch btn-large fw-700 text-base-color d-table d-lg-inline-block xl-mb-15px md-mx-auto">
                            <span>
                                <span class="btn-text">Switch icon</span>
        ...
        <section class="bg-charcoal-blue big-section">
            <div class="container">
                <div class="row justify-content-center mb-2">
                    <div class="col-12 col-lg-7 text-center">
                        <h6 class="alt-font text-white fw-600">Slide filling</h6>
                    </div>
                </div>
                <div class="row row-cols-1 justify-content-center">
                    <div class="col btn-dual text-center">
                        <a href="#" class="btn btn-large btn-transparent-white btn-slide-up d-table d-lg-inline-block lg-mb-15px md-mx-auto">Slide up<span class="bg-white"></span></a>
                        <a href="#" class="btn btn-large btn-transparent-white btn-slide-down d-table d-lg-inline-block lg-mb-15px md-mx-auto">Slide down<span class="bg-white"></span></a>
                        <a href="#" class="btn btn-large btn-transparent-white btn-slide-left d-table d-lg-inline-block lg-mb-15px md-mx-auto">Slide left<span class="bg-white"></span></a>
                        <a href="#" class="btn btn-large btn-transparent-white btn-slide-right d-table d-lg-inline-block lg-mb-15px md-mx-auto">Slide right<span class="bg-white"></span></a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="bg-very-light-gray big-section">
            <div class="container">
                <div class="row justify-content-center mb-2">
                    <div class="col-12 col-lg-7 text-center">
                        <h6 class="alt-font text-dark-gray fw-600">With rounded icon</h6>
                    </div>
                </div>
                <div class="row row-cols-1 justify-content-center">
                    <div class="col btn-dual text-center">
                        <a href="#" class="btn btn-extra-large fw-600 btn-rounded with-rounded btn-white btn-box-shadow d-table d-lg-inline-block lg-mb-15px md-mx-auto">Border dark gray<span class="bg-dark-gray text-white"><i class="fa-solid fa-arrow-right"></i></span></a>
                        <a href="#" class="btn btn-extra-large btn-rounded with-rounded btn-dark-gray d-table d-lg-inline-block lg-mb-15px md-mx-auto">Button Large<span class="bg-base-color text-white"><i class="fa-solid fa-arrow-right"></i></span></a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="bg-charcoal-blue big-section">
            <div class="container">
                <div class="row justify-content-center mb-2">
                    <div class="col-12 col-lg-7 text-center">
                        <h6 class="alt-font text-white fw-600">Expanded background</h6>
                    </div>
                </div>
                <div class="row row-cols-1">
                    <div class="col btn-dual text-center">
                        <a href="#" class="btn btn-extra-large btn-expand text-white left-icon d-table d-lg-inline-block lg-mb-15px md-mx-auto"><span class="bg-gradient-fast-blue-purple"></span><i class="ti-email"></i>Expanded gradient</a>
                        <a href="#" class="btn btn-extra-large btn-expand text-white d-table d-lg-inline-block lg-mb-15px md-mx-auto"><span class="bg-base-color"></span>Expanded Flat color</a>
                        <a href="#" class="btn btn-extra-large btn-expand-ltr text-white text-white-hover btn-rounded d-table d-lg-inline-block lg-mb-15px md-mx-auto"><span class="bg-base-color"></span>Expanded Flat color</a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="bg-very-light-gray big-section">
            <div class="container">
                <div class="row justify-content-center mb-2">
                    <div class="col-12 col-lg-7 text-center">
                        <h6 class="alt-font text-dark-gray fw-600">Icon hover animations</h6>
                    </div>
                </div>
                <div class="row row-cols-1 justify-content-center">
                    <div class="col btn-dual text-center"> 
                        <a href="#" class="btn btn-large btn-transparent-base-color btn-icon-left btn-hover-animation d-table d-lg-inline-block lg-mb-15px md-mx-auto">
                            <span>
                                <span class="btn-icon"><i class="fa-solid fa-arrow-left"></i></span> 
                                <span class="btn-text">Reveal icon left</span> 
                            </span>
                        </a>
                        <a href="#" class="btn btn-large btn-base-color btn-hover-animation d-table d-lg-inline-block lg-mb-15px md-mx-auto">
                            <span> 
                                <span class="btn-text">Reveal icon right</span> 
                                <span class="btn-icon"><i class="fa-solid fa-arrow-right"></i></span> 
                            </span>
                        </a>
                        <a href="#" class="btn btn-large btn-transparent-base-color btn-hover-animation-switch d-table d-lg-inline-block lg-mb-15px md-mx-auto">
                            <span>
                                <span class="btn-text">Switch icon left</span>
                                <span class="btn-icon"><i class="fa-solid fa-arrow-right"></i></span>
                                <span class="btn-icon"><i class="fa-solid fa-arrow-right"></i></span>
                            </span> 
                        </a> 
                        <a href="#" class="btn btn-large btn-base-color btn-hover-animation-switch btn-icon-left d-table d-lg-inline-block lg-mb-15px md-mx-auto">
                            <span>
                                <span class="btn-text">Switch icon right</span>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-7 text-center mb-2">
                        <h6 class="alt-font text-white fw-600">Border button</h6>
                    </div>
                </div>
                <div class="row row-cols-1 justify-content-center">
                    <div class="col btn-dual text-center">
                        <a href="#" class="btn btn-large btn-double-border btn-border-color-white d-table d-lg-inline-block lg-mb-25px md-mx-auto">
                            <span>
                                <span class="btn-double-text" data-text="Border button">Border button</span> 
                            </span>
                        </a>
                        <a href="#" class="btn btn-large btn-double-border btn-border-base-color hover-border-color-white d-table d-lg-inline-block lg-mb-25px md-mx-auto">
                            <span>
                                <span class="btn-double-text" data-text="Border button">Border button</span> 
                            </span>
                        </a>
                        <a href="#" class="btn btn-large btn-double-border btn-border-color-transparent-white d-table d-lg-inline-block lg-mb-25px md-mx-auto">
                            <span>
                                <span class="btn-double-text" data-text="Border button">Border button</span> 
                            </span>
                        </a> 
        ...
        <section class="big-section">
            <div class="container">
                <div class="row justify-content-center mb-2">
                    <div class="col-12 col-lg-7 text-center">
                        <h6 class="alt-font text-dark-gray fw-600">Switch text button </h6>
                    </div>
                </div>
                <div class="row row-cols-1 justify-content-center">
                    <div class="col btn-dual text-center">
                        <a href="#" class="btn btn-base-color btn-large btn-switch-text d-table d-lg-inline-block lg-mb-15px md-mx-auto">
                            <span>
                                <span class="btn-double-text" data-text="Button Extra Large">Button Extra Large</span> 
                            </span>
                        </a>
                        <a href="#" class="btn btn-large btn-switch-text btn-round-edge btn-transparent-light-gray d-table d-lg-inline-block lg-mb-15px md-mx-auto">
                            <span>
                                <span class="btn-double-text" data-text="Border light color">Border light color</span> 
                            </span>
                        </a>
                        <a href="#" class="btn btn-large btn-switch-text btn-base-color d-table d-lg-inline-block lg-mb-15px md-mx-auto">
                            <span>
                                <span class="btn-double-text" data-text="Switch button">Switch button</span>
                                <span><i class="fa-solid fa-arrow-right"></i></span>
                            </span>
                        </a>
                        <a href="#" class="btn btn-large btn-switch-text btn-base-color left-icon d-table d-lg-inline-block lg-mb-15px md-mx-auto">
                            <span>
